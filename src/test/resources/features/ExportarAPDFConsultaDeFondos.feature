...
Feature: Exportar a PDF la consulta de fondos

  Background:
  El usuario ejecuta el navegador
    And El sistema muestra el navegador
    And El usuario captura la URL
    When El sistema muestra la página

  Scenario : Exportar a PDF la consulta de fondos al ingresar como Admin Master
    ...
    And El usuario da click en botón "exportar a PDF" consulta de fondos
    And El sistema comienza la descarga de Fondos en "Formato PDF"
