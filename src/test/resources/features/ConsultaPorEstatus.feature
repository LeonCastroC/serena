...
Feature: Consulta por estatus
  ...
  Scenario: Consulta por estatus al ingresar como Admin Master
    ...
    And El usuario selecciona estatus = "Todo" y da click en botón Filtrar
    And El sistema muestra las solicitudes de saldo de los estatus "Todo"
    And El usuario selecciona estatus = "Pendiente por Administrador" y da click en botón Filtrar
    And El sistema muestra las solicitudes de saldo de los estatus "Pendiente por Administrador"
    And El usuario selecciona estatus = "Denegada por Administrador" y da click en botón Filtrar
    And El sistema muestra las solicitudes de saldo de los estatus "Denegada por Administrador"
