...
Feature: Asignar Tarjeta personalizada desde Tarjetas | Administración | Asignaciones
  ...
  Scenario: Asignar Tarjeta personalizada desde Tarjetas | Administración | Asignaciones al ingresar como Admin Usuario
    ...
    And El usuario selecciona tipo de tarjeta "Personalizada"
