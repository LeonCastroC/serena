...
Feature: Deshabilitar CVV dinámico de Tarjeta con regla de uso Ecommerce
  ...
  Scenario: Deshabilitar CVV dinámico de Tarjeta con regla de uso Ecommerce al ingresar como Admin Master
    ...
    And El usuario busca tarjeta con regla de uso "Ecommerce"
    And El sistema muestra switch "Deshabilitar CVV Dinámico" habilitado
    And El usuario da click en switch "Deshabilitar CVV Dinámico" en tarjeta con regla de uso Ecommerce
    Then El sistema muestra el switch deshabilitado en tarjeta con regla de uso Ecommerce
