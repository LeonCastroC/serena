...
Feature: Descarga de consulta de Estados de cuentas a PDF
  ...
  Scenario: Descarga de consulta de Estados de cuentas a PDF al ingresar como Admin Master
    ...
    And El usuario da click en Descargar estado de cuenta a "PDF"
    Then El sistema comienza la descarga del archivo en formato "PDF"
