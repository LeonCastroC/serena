...
Feature: Exportar la consulta de Proforma a Excel
  ...
  Scenario: Exportar la consulta de Proforma a Excel al ingresar como Admin Master
    ...
    And El usuario selecciona opción de "Proformas"
    And El sistema muestra pantalla de "Proformas"
    And El usuario da click en botón "exportar a Excel" consultas Proformas
    And El sistema comienza la descarga de consultas Proformas en "Formato excel"
