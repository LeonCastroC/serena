...
Feature: Exportar a Excel la Consulta de Información de usuarios
  ...
  Scenario: Exportar a Excel la Consulta de Información de usuarios al ingresar como Admin Master
    ...
    And El usuario da clic en "Información de usuario"
