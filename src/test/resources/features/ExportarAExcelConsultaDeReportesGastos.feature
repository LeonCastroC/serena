...
Feature: Exportar a Excel la consulta de Reportes de Gastos
  ...
  Scenario: Exportar a Excel la consulta de Reportes de Gastos al ingresar como Admin Master
    ...
    And El sistema muestra pantalla de "Reporte de gastos" de tarjetas
    And El usuario da click en botón "exportar a Excel" consulta de reporte de gastos
    And El sistema comienza la descarga de reporte de gastos en "Formato excel"
