...
Feature: Desactivar notificaciones de Saldo- Asignación de Saldo Online
  ...
  Scenario: Desactivar notificaciones de Asignación de Saldo Online al ingresar como Admin Usuario
    ...
    And El usuario despliega información de "Asignaciones" de saldos
    And El sistema muestra la información de "Asignaciones" de saldos
    And El usuario deshabilita switch de asignaciones "en linea"

    And El sistema habilita botón de "Guardar" y muestra resumen de deshabilitar notificaciones
    And El usuario da click en botón "Guardar" para deshabilitar notificaciones
